...
**/
	...
	/* ========== Variable Declaration ========== */
        ...
        // -------- Frame Source | Main Page -------- //
            ...
            var I_apple_source_frame = "<iframe allow='autoplay *; encrypted-media *;' frameborder='0' height='400px' style='width:100%;max-width:660px;overflow:hidden;background:transparent;' sandbox='allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation-by-user-activation' src='https://embed.music.apple.com/ca/album/up-all-night-ep/1476702376?app=music'></iframe>";
            var I_soundcloud_source_frame = "<iframe width='100%' height='400' scrolling='no' frameborder='no' allow='autoplay' src='https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/843222926&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true'></iframe>";
            var I_spotify_source_frame = "<iframe src='https://open.spotify.com/embed/artist/6HwBvmFxQ5dErzS6UrvfPe&theme=red'width='100%' height='400' frameborder='0' allowtransparency='true' allow='encrypted-media'></iframe>";
