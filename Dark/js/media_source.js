...
**/
	...
	/* ========== Variable Declaration ========== */
        ...
        // -------- Frame Source | Main Page -------- //
            ...
            var I_apple_source_frame = "<iframe style='margin-top: -40px!important;' allow='autoplay *; encrypted-media *;' frameborder='0' height='400px' style='width:100%;max-width:660px;overflow:hidden;background:transparent;' sandbox='allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation-by-user-activation' src='https://embed.music.apple.com/ca/album/up-all-night-ep/1476702376?app=music'></iframe>";
            ...
            var I_spotify_source_frame = "<iframe style='margin-top: -40px!important;' src='https://open.spotify.com/embed/artist/6HwBvmFxQ5dErzS6UrvfPe&theme=red'width='100%' height='400' frameborder='0' allowtransparency='true' allow='encrypted-media'></iframe>";
