...
var Notiflix = {
    ...
    Report: {
        ...
        Failure: function (title, message, buttonText, buttonCallback) {
            ...
            if (arguments[1] === undefined || arguments[1].length <= 0) { // message
                arguments[1] = '"Notiflix uses cookies to personalise content and adverts and to analyse traffic.';
            }
        ...
        Info: function (title, message, buttonText, buttonCallback) {
            ...
            if (arguments[1] === undefined || arguments[1].length <= 0) { // message
                arguments[1] = 'Since your last visit we have added content to the webpage <br><br>';
            }
